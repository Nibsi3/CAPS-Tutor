 ...
 * 
 * Run with: npx tsx scripts/add-dateofbirth-attribute.ts
 * 
 * Requirements:
 * - APPWRITE_ENDPOINT environment variable
 * - APPWRITE_PROJECT_ID environment variable
