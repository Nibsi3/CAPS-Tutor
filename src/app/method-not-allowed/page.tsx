...
import { Home, LayoutDashboard, Lightbulb, AlertTriangle } from 'lucide-react';
...
export default function MethodNotAllowedPage() {
  ...
  useEffect(() => {
    ...
    function render() {
      ...
      ctx.fillStyle = `rgba(${textRGB.r}, ${textRGB.g}, ${textRGB.b}, 0.2)`;
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-full max-w-md px-6">
        <Card className="border border-border/50 bg-card/40 backdrop-blur-md shadow-2xl">
          <CardContent className="pt-8 pb-8 text-center space-y-6">
            ...
            <h1 className="text-7xl font-bold font-headline text-yellow-500">
              405
            </h1>
