...
const allQuestions: Record<string, Question[]> = {
  ...
  "Mathematics": [
    ...
    { id: 'math-g12-p1-24', topic: 'Probability', question: 'A password consists of 3 letters followed by 2 digits. How many passwords can be formed if repetition is allowed?' },
