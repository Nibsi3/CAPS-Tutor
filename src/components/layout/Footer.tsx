      ...
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-8 px-6 py-10 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm text-muted-foreground">
            <li><a className="hover:text-primary" href="/how-it-works">How It Works</a></li>
            <li><a className="hover:text-primary" href="/caps-syllabus">CAPS Syllabus</a></li>
            <li><a className="hover:text-primary" href="/all-subjects">All Subjects</a></li>
